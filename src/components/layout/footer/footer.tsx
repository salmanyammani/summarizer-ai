...
// Custom components to replace shadcn components

const CustomLabel = ({ children, className, htmlFor, ...props }:any) => {
  return (
    <label
      htmlFor={htmlFor}
...
const CustomInput = ({ className, type = "text", ...props }:any) => {
  return (
    <input
      type={type}
          ...
          <div>
            ...
            <form className="mt-12 w-full max-w-xs">
              <div className="space-y-2.5">
                <CustomLabel className="block text-sm font-medium" htmlFor="email">
             ...
             <Button className="text-stone-900 mt-3 text-sm" variant={"default"}>Subscribe</Button>
            </form>
          </div>
        </div>
        <div className="bg-muted mt-16 flex items-center justify-between rounded-md p-4 px-6 py-3">
          <span className="text-title">&copy; YamDevs 2025 - Present</span>
